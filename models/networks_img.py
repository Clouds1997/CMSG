...
class ImageEncoder_Base(nn.Module):
    def __init__(self, opt):
        super(ImageEncoder_Base, self).__init__()
        self.opt = opt

        self.backbone = resnet.resnet34(in_channels=3, pretrained=False, progress=True)
...
class ImageEncoder(nn.Module):
    def __init__(self, opt):
        ...
        self.backbone = resnet.resnet34(in_channels=4, pretrained=False, progress=True)
