...
def process_kitti(input_root_path,
                  ...
                  sn_max_nn):
    for seq in seq_list:
        input_folder = os.path.join(input_root_path, 'data')
        ...
        for i in range(sample_num):
            ...
            data_np = read_velodyne_bin(os.path.join(input_folder, '%010d.bin' % i))
            pc_np = data_np[0:3, :]
...
if __name__ == '__main__':
    input_root_path = '2011_10_03/2011_10_03_drive_0027_sync/velodyne_points'
    output_root_path = 'dataset/kitti/data_odometry_velodyne/sequences'
