...
from models.multimodal_classifier import MMClassiferSe, MMClassiferSeDime,Classifergraph
...
if __name__=='__main__':
    ...
    for epoch in epochs:
        ...
        for i, data in tqdm(enumerate(trainloader), total=len(trainloader), desc="Batches"):
            ...
            # 图网络版本
            # model.set_input(pc, intensity, sn, label, node_a, node_b, pc_graph, img_graph,
            #                 P, img, K, target)
            time4 = time.time()
